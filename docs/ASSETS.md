...
`public/fonts/nicoding-sans-sc.woff2`：Noto Sans SC 可变字体的课程字符子集，约 334 KB。中文标题、正文和知识树统一使用此字体，代码继续使用等宽字体，Nicoding 字标保持原图。字体随网站提供，不依赖字体 CDN；未包含的用户输入字符由系统中文字体补足。

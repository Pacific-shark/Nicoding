...
export default function App(){
 ...
 return <div ref={pageRef} className={`app page-${page}`}>
  ...
  {state.settings.pet&&<Pet lesson={petLesson} completed={lessons.filter(l=>state.lessons[l.id]?.completed).length} suspended={!!modal} workspace={page==='projects'} onLearn={learn} onTeach={id=>navigate('learn',id+'/explain')} onProject={id=>navigate('projects',id)} motion={state.settings.motion} celebration={celebration} resetKey={petReset}/>}

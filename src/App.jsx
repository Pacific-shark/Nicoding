...
export default function App(){
 ...
 useEffect(()=>{
  document.title=(page==='chapter'?chapters[id].name:page==='journey'?journeys[id].title:page==='learn'?l.title:page==='path'?domains.find(d=>d.id===id).name:({explore:'Nico 小店的第一版',library:'知识索引',review:'复习',projects:'实践项目',missing:'页面未找到'}[page]))+' · Nicoding';
  window.scrollTo(0,0);

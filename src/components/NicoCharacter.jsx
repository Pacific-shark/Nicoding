...
export default function NicoCharacter({pose=0,motion=true,className=''}) {
 ...
 const maskId=`nico-matte-${id}`,filterId=`nico-matte-clean-${id}`,pawId=`nico-black-paw-${id}`,walkPawId=`nico-white-paw-${id}`;
 ...
 // Only this hind paw has black pads. Its fur, ankle and toe tips stay white,
 // including the dorsal surface visible while walking.

...
import NicoCharacter from './NicoCharacter.jsx';
export default function NicoCompanion({motion,celebration,resetKey,lesson,completed,onLearn,onTeach,onProject,suspended=false,workspace=false,study=false,cover=false}) {
 ...
 useEffect(()=>{if(cover){setMinimized(true);setMenu(false);}},[cover]);
 useEffect(()=>{
  if(!menu)return;

...
import {ArrowRight,ArrowLeft,Check,ChevronRight,ChevronDown,X,Search,Settings2,Play,RotateCcw,Plus,Minus,Focus,ExternalLink,BookOpen,Braces,Globe,Blocks,Sigma,ChartNoAxesCombined,Network,Route,Sparkles,Clock,Lightbulb,CheckCircle2,FileText,Download,Upload,VolumeX,PawPrint,Move,PanelRightClose,Menu,Code2,NotebookPen,LockKeyhole,Command,Target,RefreshCw,CircleHelp,Maximize2,Minimize2,Bookmark,Info,Sun,Terminal,ChevronUp,Save,StopCircle,MousePointer2,CircleCheck,CircleX,Circle,CircleAlert,Ellipsis,FileCode2,ArrowUpRight,Folder,LoaderCircle,RotateCw,ListChecks,Square,ChevronsUpDown,PanelsTopLeft,User,Package,Flag,FileCheck2,ScanLine} from 'lucide-react';
const icons={ArrowRight,ArrowLeft,Check,ChevronRight,ChevronDown,X,Search,Settings2,Play,RotateCcw,Plus,Minus,Focus,ExternalLink,BookOpen,Braces,Globe,Blocks,Sigma,ChartNoAxesCombined,Network,Route,Sparkles,Clock,Lightbulb,CheckCircle2,FileText,Download,Upload,VolumeX,PawPrint,Move,PanelRightClose,Menu,Code2,NotebookPen,LockKeyhole,Command,Target,RefreshCw,CircleHelp,Maximize2,Minimize2,Bookmark,Info,Sun,Terminal,ChevronUp,Save,StopCircle,MousePointer2,CircleCheck,CircleX,Circle,CircleAlert,Ellipsis,FileCode2,ArrowUpRight,Folder,LoaderCircle,RotateCw,ListChecks,Square,ChevronsUpDown,PanelsTopLeft,User,Package,Flag,FileCheck2,ScanLine};
